...
public class Dragon {
    public static final String FILE_TREASURES = "src\\com\\company\\epam\\part5\\dragon\\resourses\\Treasures.txt";
    public static final String FILE_TREASURES_CHOICE = "src\\com\\company\\epam\\part5\\dragon\\resourses\\TreasuresChoice.txt";
    private String name;
    ...
    private List<Treasure> readTreasure() {
        try (BufferedReader readerFile = new BufferedReader(new FileReader(Dragon.FILE_TREASURES))) {
    ...
    private void writeFile(List<Treasure> treasureList, String pathFile, StringBuilder str) {
        try {
            ...
            Files.write(Paths.get(pathFile), Collections.singleton(str.toString()));
        } catch (IOException e) {
    ...
    public List<Treasure> selectTreasureAmount(int amount) throws IOException {
        ...
        writeFile(list, FILE_TREASURES_CHOICE, str);
        reader.close();
        return list;
    }
